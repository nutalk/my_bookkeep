...
export default function SettingsPage() {
  ...
  // 支持 ?tab=ai / ?tab=theme 直达（如 AI 助手面板的「去设置」链接）
  useEffect(() => {
    const t = new URLSearchParams(window.location.search).get("tab");
    if (t === "ai" || t === "theme") setSection(t);
  }, []);
  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      <h1 className="text-2xl font-bold text-white mb-1">账号设置</h1>
      <p className="text-neutral-400 mb-6">管理数据、AI 接口与页面主题</p>
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div className="h-2 w-6 mx-auto mt-1 rounded-sm" style={{ background: opt.text }} />
                  <div className="h-2 w-4 mx-auto mt-1 rounded-sm opacity-60" style={{ background: opt.text }} />
                </div>
                <div>
