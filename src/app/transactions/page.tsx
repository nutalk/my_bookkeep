...
import { balanceEffect } from "@/lib/ledger";
...
export default function TransactionsPage() {
  ...
  // 金额的正负号按「对余额的实际影响」来显示，而不是按类型硬编码，
  // 否则 reconciliation 这类差额可能为负的交易会一律显示成减号。
  const renderAmount = (t: Transaction) => {
    const effect = balanceEffect(t);
    const signed = effect ?? t.amount;
    return (
      <>
        {effect === null ? "" : signed >= 0 ? "+" : "-"}
